...
export class SpecialistSpecialityControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllSpecialitySpecialistsByIdUsingGET(specialityId: number, observe?: 'body', reportProgress?: boolean): Observable<Array<SpecialistDTO>>;
    public getAllSpecialitySpecialistsByIdUsingGET(specialityId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<SpecialistDTO>>>;
    public getAllSpecialitySpecialistsByIdUsingGET(specialityId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<SpecialistDTO>>>;
    public getAllSpecialitySpecialistsByIdUsingGET(specialityId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<SpecialistDTO>>('get',`${this.basePath}/specialist-specialities/getAllSpecialitySpecialistsById`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
