...
import { planingsTimesMaker } from "./planings-times"
/**
...
export const APPOINTMENT_STATES: { pending: string, accept: string, cancel: string } = { pending: 'PENDING', accept: "ACCEPTED", cancel: "CANCELED" };
export const PLANINGS_TIMES: { order: number, time: string }[] = planingsTimesMaker(8, 17);
