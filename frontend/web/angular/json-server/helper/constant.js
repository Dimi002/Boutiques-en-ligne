module.exports = {
  ...
  // appointment haour pattern

  APPOINTMENT_HOUR_PATTERN: '..:.. .M',
  ...
  ITEM_ALREADY_DELETED: '502',
  ITEM_ALREADY_DEACTIVATED: '503',
  ITEM_IS_REQUIRED: '504',
  SERVER_DENY_RESPONSE: '504',
  SLOT_TIME_NOT_FREE: '505',
  INVALID_INPUT: '506',
  FILE_NOT_READ: '507',
  FILE_NOT_DOWNLOAD: '508',
  MAIL_NOT_SEND: '509',
  NOT_ACTIVE_ITEM: '510',
  RUN_TIME: '511',
  NULL_POINTER: '512',
 ...
 * @returns
 */
function getError(stringErrorCode, errorText){
  return {
    stringErrorCode: stringErrorCode,
    errorText: errorText
  };
}
