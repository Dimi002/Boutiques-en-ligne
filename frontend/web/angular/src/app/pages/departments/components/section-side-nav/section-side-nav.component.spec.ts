...
import { ApiModule, Speciality, SpecialityControllerService } from 'src/app/generated';
import { getConfiguration } from 'src/app/app.module';
import { ImageService } from 'src/app/services/image.service';
import { ActivatedRoute, RouterModule } from '@angular/router';
import { AppRoutingModule } from 'src/app/app-routing.module';
import { RouterTestingModule } from '@angular/router/testing';
import { SectionSideNavComponent } from './section-side-nav.component';

describe('section side nav', () => {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [SectionSideNavComponent],
            imports: [
                HttpClientModule,
                AppRoutingModule,
                RouterModule,
    ...
    it('should section side', () => {
        expect(component).toBeTruthy();
    });


    it('should sectActiveDepartment', () => {
        const departments: Speciality = {
            "specialityName": "AVOBENZONE, OCTOCRYLENE, OXYBENZONE",
            "specialistCommonName": "Bismuth subsalicylate",
            "specialityDesc": "unleash front-end systems",
            "specialityImagePath": "Storage/Images/1665402814577-chirurgie.jpeg",
            "status": 2,
        ...
        component.sectActiveDepartment(departments);
    });
